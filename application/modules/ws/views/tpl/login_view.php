                        ...
                        ?>
                            <fieldset>
                                <div class="form-group">
                                    ...
                                    <input class="form-control" placeholder="Username Feeder" value="<?php echo set_value('username'); ?>" name="username" autofocus>
                                </div>
                                <div class="form-group">
                                	<label>Password Feeder</label>
                                    <input type="password" id="inputPassword" name="password" class="form-control" placeholder="Password Feeder" >
                                </div>
                                <div class="form-group">

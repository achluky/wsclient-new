								...
								<div class=\"col-md-4 col-md-offset-4\">
									<div class=\"panel panel-danger\">
										<div class=\"panel-heading\">
											<h3 class=\"panel-title\">Parameter KRS</h3>
										</div>
										<div class=\"panel-body\">
											<form action=\"".base_url()."krskhs/createkrs\" class=\"frm_krskhs\">
												...
												<button type=\"submit\" class=\"btn btn-danger btn-sm btn-generate\">Generate KRS</button>
											</form>
										</div>
									</div>
								</div>
